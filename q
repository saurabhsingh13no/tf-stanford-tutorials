...
DDEESSCCRRIIPPTTIIOONN
       ...
       --cc     with --lltt: sort by, and show, ctime (time of last modification of file status information); with --ll: show ctime and sort by name; otherwise: sort by ctime,
              newest first
       ...
       --hh, ----hhuummaann--rreeaaddaabbllee
              with --ll and/or --ss, print human readable sizes (e.g., 1K 234M 2G)
       ...
       ----ttiimmee=_W_O_R_D
              with --ll, show time as WORD instead of default modification time: atime or access or use (--uu); ctime or status (--cc); also use specified time as sort key if
              ----ssoorrtt=_t_i_m_e (newest first)

       ----ttiimmee--ssttyyllee=_S_T_Y_L_E
              with  --ll,  show  times  using  style  STYLE:  full-iso, long-iso, iso, locale, or +FORMAT; FORMAT is interpreted like in 'date'; if FORMAT is FORMAT1<new‐
              line>FORMAT2, then FORMAT1 applies to non-recent files and FORMAT2 to recent files; if STYLE is prefixed with 'posix-', STYLE takes  effect  only  outside
              the POSIX locale
       ...
       Using  color  to distinguish file types is disabled both by default and with ----ccoolloorr=_n_e_v_e_r.  With ----ccoolloorr=_a_u_t_o, ls emits color codes only when standard output is
